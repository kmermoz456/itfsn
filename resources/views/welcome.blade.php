...
<section id="hero" class="relative isolate overflow-hidden">
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
    <div class="max-w-2xl text-white">
      <span class="inline-flex items-center rounded-full bg-emerald-500/20 px-3 py-1 text-xs font-semibold text-green-300 ring-1 ring-inset ring-green-400/30">
      ...
      <div class="mt-8 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
        <a href="{{route('students.create')}}"
          class="inline-flex justify-center items-center rounded-md bg-emerald-500 px-5 py-3 text-sm font-semibold text-white hover:bg-green-400 active:bg-green-600 transition">
        ...
        <a href="https://chat.whatsapp.com/DStI9zHPEyRIMYWRBELLR2?mode=ac_t" target="_blank" rel="noopener"
          class="inline-flex items-center gap-2 rounded-2xl bg-[#ffffff] px-5 py-3 text-green-300 font-semibold
          shadow-lg hover:brightness-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#25D366]">
          <!-- Icône WhatsApp inline (une seule path) -->
          <svg class="h-5 w-5" viewBox="0 0 24 24" aria-hidden="true" fill="currentColor">
            <path d="M20.52 3.48A11.94 11.94 0 0 0 12 0C5.37 0 0 5.37 0 12c0 2.11.55 4.1 1.6 5.88L0 24l6.29-1.64A12 12 0 1 0 20.52 3.48zM12 21.85c-1.86 0-3.66-.49-5.24-1.42l-.38-.22-3.73.97.99-3.64-.25-.4A9.86 9.86 0 1 1 12 21.85zm5.47-7.47c-.3-.15-1.76-.87-2.03-.97-.27-.1-.44-.15-.63.15-.18.27-.72.98-.88 1.18-.16.2-.32.22-.6.08-.3-.15-1.25-.46-2.38-1.47-.88-.79-1.47-1.76-1.64-2.04-.17-.28-.02-.43.13-.58.13-.13.3-.34.45-.51.15-.17.2-.29.3-.48.1-.19.05-.36-.03-.51-.08-.15-.63-1.52-.86-2.08-.23-.56-.47-.48-.64-.49l-.55-.01c-.19 0-.5.07-.76.36-.26.29-1 1-1 2.44s1.02 2.83 1.16 3.03c.14.2 2.01 3.19 4.86 4.47.68.3 1.21.48 1.61.61.68.22 1.3.19 1.79.12.55-.08 1.76-.72 2.01-1.41.25-.7.25-1.3.17-1.44-.08-.13-.29-.21-.6-.36z" />
          </svg>
          <span>Rejoignez notre groupe WhatsApp</span>
        </a>
      ...
      <div class="space-y-6">
        ...
        <div class="flex items-start gap-4 rounded-2xl bg-indigo-50/70 p-5 shadow-sm hover:shadow-md transition">
          <div class="shrink-0 h-12 w-12 rounded-xl bg-indigo-600 text-white flex items-center justify-center">
            ...
            <svg class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
              <path d="M3 3h2v14h16v2H3V3zm16 2l-5.5 6-3-3L6 16h14V5z" />
            </svg>
          </div>
          <div>
        ...
        <div class="flex items-start gap-4 rounded-2xl bg-sky-50 p-5 shadow-sm hover:shadow-md transition">
          <div class="shrink-0 h-12 w-12 rounded-xl bg-sky-600 text-white flex items-center justify-center">
            <!-- icône: smile -->
            <svg class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 2a10 10 0 100 20 10 10 0 000-20zm-3 7a1.5 1.5 0 110 3 1.5 1.5 0 010-3zm6 0a1.5 1.5 0 110 3 1.5 1.5 0 010-3zM7.5 14a5.5 5.5 0 009 0H7.5z" />
            </svg>
          </div>
          <div>
        ...
        <div class="flex items-start gap-4 rounded-2xl bg-emerald-50 p-5 shadow-sm hover:shadow-md transition">
          <div class="shrink-0 h-12 w-12 rounded-xl bg-emerald-600 text-white flex items-center justify-center">
            <!-- icône: ticket/offer -->
            <svg class="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
              <path d="M3 5a2 2 0 012-2h6v4a2 2 0 104 0V3h2a2 2 0 012 2v4a2 2 0 100 4v4a2 2 0 01-2 2h-6v-4a2 2 0 10-4 0v4H5a2 2 0 01-2-2V13a2 2 0 100-4V5z" />
            </svg>
          </div>
          <div>
        ...
        <div class="pt-2">
          <a href="{{route('students.create')}}"
            class="inline-flex items-center gap-2 rounded-xl bg-emerald-500 px-5 py-3 text-sm font-semibold text-black shadow hover:bg-green-400 active:bg-green-600 transition">
            S’inscrire maintenant
