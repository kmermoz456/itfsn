...
<div class="flex items-center justify-between">
  <h2 class="text-xl font-extrabold">Étudiants inscrits</h2>
  <form method="GET" class="w-64">
    <input name="s" value="{{ $s }}" placeholder="Rechercher…"
           class="w-full rounded-lg border-gray-200" />
  </form>
</div>

<div x-data="{q:''}" class="mt-4">
  <input x-model="q" placeholder="Filtrer dans cette page…" class="w-full rounded-lg border-gray-200 mb-3" />
